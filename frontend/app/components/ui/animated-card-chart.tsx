...
export function AnimatedCardChart({ className, ...props }: CardProps) {
  return (
    <div
      role="region"
      ...
      className={cn(
        "group/animated-card relative w-[356px] overflow-hidden rounded-xl border border-zinc-200 bg-white shadow-sm",
        className
      )}
      {...props}
    />
...
export function CardBodyChart({ className, ...props }: CardProps) {
  return (
    <div
      role="group"
      className={cn(
        "flex flex-col space-y-1.5 border-t border-zinc-200 p-4",
        className
      )}
      {...props}
    />
...
export function CardTitleChart({ className, ...props }: CardTitleProps) {
  return (
    <h3
      className={cn(
...
export function CardDescriptionChart({ className, ...props }: CardDescriptionProps) {
  return (
    <p
      className={cn(
...
export function CardVisualChart({ className, ...props }: CardProps) {
  return (
    <div
...
const Layer1: React.FC<LayerProps> = ({ color, secondaryColor }) => {
  return (
    ...
    >
      <div className="flex shrink-0 items-center rounded-full border border-zinc-200 bg-white/25 px-1.5 py-0.5 backdrop-blur-sm transition-opacity duration-300 ease-in-out group-hover/animated-card:opacity-0">
  ...
  return (
    ...
    >
      <div className="ease-[cubic-bezier(0.6, 0.6, 0, 1)] absolute inset-0 z-[7] flex w-[356px] translate-y-full items-start justify-center bg-transparent p-4 transition-transform duration-500 group-hover/animated-card:translate-y-0">
        <div className="ease-[cubic-bezier(0.6, 0, 1)] rounded-md border border-zinc-200 bg-white/25 p-1.5 opacity-0 backdrop-blur-sm transition-opacity duration-500 group-hover/animated-card:opacity-100">
